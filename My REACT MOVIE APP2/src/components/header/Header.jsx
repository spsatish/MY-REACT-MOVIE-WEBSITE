    ...
    return (
        <header className={`header ${mobileMenu ? "mobileView" : ""} ${show}`}>
          <ContentWrapper>
            ...
            <li className="menuItem" onClick={()=>{navigationHandler("movielibrary")}}>Movie Library</li>
            <li className="menuItem" onClick={()=>{navigationHandler("tvlibrary")}}>TV Library</li>
            <li className="menuItem" onClick={()=>{navigationHandler("login")}}>Login/Signup</li>
